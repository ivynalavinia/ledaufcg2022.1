...
public class StudentDoubleLinkedListTest extends StudentLinkedListTest {
	...
	private void getImplementations() {
		...
		lista2 = new DoubleLinkedListImpl<>(); //TODO entender porque ele manteve essa double aqui
	...
	// Meus testes
		...
		public void myTestDoubleGeral() {
			...
			Assert.assertArrayEquals(new Integer[] { 7,2,6,6,0,-3 }, lista2.toArray());

			((DoubleLinkedList<Integer>) lista2).removeFirst();
			Assert.assertArrayEquals(new Integer[] { 2,6,6,0,-3 }, lista2.toArray());

			((DoubleLinkedList<Integer>) lista2).removeLast();
			Assert.assertArrayEquals(new Integer[] { 2,6,6,0 }, lista2.toArray());

			((DoubleLinkedList<Integer>) lista2).removeLast();
			((DoubleLinkedList<Integer>) lista2).removeFirst();
			Assert.assertArrayEquals(new Integer[] { 6,6 }, lista2.toArray());
			...
			Assert.assertArrayEquals(new Integer[] { 6,3,9,6,6 }, lista2.toArray());

			((DoubleLinkedList<Integer>) lista2).removeLast();
			((DoubleLinkedList<Integer>) lista2).removeLast();
			Assert.assertArrayEquals(new Integer[] { 6,3,9 }, lista2.toArray());
